...
const FlockMasterPageDesign = require('ui/ui_flockMasterPage');
...
const FlockMasterPage = extend(FlockMasterPageDesign)(
  // Start superFunction 
  function(_super) {
    _super(this);
    ...
    var myItem = new HeaderBarItem({title: "Add New Flock", onPress: function() { Router.go("addFlockPage");}    });
...
function listView(myListView, myDataSet){
  ...
  myListView.onRowCreate = function() {
    ...
    myLabel3.bottom = 1;
    myFlexLayout.addChild(myLabel3);
  ...
  myListView.onRowBind = function(listViewItem, index) {
    //1. title
      ...
      var titleDegeri = " Flock ID:";
      titleDegeri += myDataSet[index].flockid;
      yeni.text = titleDegeri;
      //2. title
      yeni = myLabelTitle1.findChildById(105);
      titleDegeri = " Flock Desc:";
      titleDegeri += myDataSet[index].flockdsc1;
      yeni.text = titleDegeri;
      //3. title
      yeni = myLabelTitle1.findChildById(106);
      titleDegeri = " Farm Code:";
...
module && (module.exports = FlockMasterPage);